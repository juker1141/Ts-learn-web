...
function () {
  function Eventing() {
    ...
    this.events = {}; // 使用 arrow Function 這樣他就沒有自己的 this
    // 會呼叫他父元素身上的 this
...
function () {
  function Model(attributes, sync, events) {
    ...
    this.sync = sync;
    this.events = events; // 因為是使用 constructor 一開始的初始化，而不是後來才分配值的方式
    // 所以可以簡寫
...
function () {
  function Attributes(data) {
    ...
    this.data = data; // 泛型: K 是 T 物件的一個 key 值
...
function () {
  ...
  ApiSync.prototype.save = function (data) {
    var id = data.id; // 如果有 id 那代表該 User 已經存在資料庫，put更改既有資料
    // 反之新增一筆 User 資料
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts"}],"../../../../usr/local/Cellar/nvm/0.38.0/versions/node/v14.18.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../usr/local/Cellar/nvm/0.38.0/versions/node/v14.18.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
